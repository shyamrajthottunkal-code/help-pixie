...
import { Plus, LogOut, MessageSquare, Phone, MessageCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-muted to-secondary">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Card className="p-6 mb-6 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
          <h3 className="text-lg font-semibold mb-3">Need Help? Contact Admin</h3>
          <div className="flex flex-wrap gap-3">
            <a
              href="https://wa.me/919744027104"
              target="_blank"
